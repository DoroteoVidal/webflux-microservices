...
import com.dorovidal.webfluxdemo.exception.InputValidationException;
...
public class CalculatorRouterConfig {
    ...
    private RouterFunction<ServerResponse> serverResponseRouterFunction() {
        return RouterFunctions.route()
                ...
                .GET("{a}/{b}", isOperation("*"), handler::multiplicationnHandler)
                .GET("{a}/{b}", isOperation("/"), handler::divisionnHandler)
